    ...
    public static void main(String[] args){
        ...
        while (true) {
            ...
            System.out.println("""
                ...
                112 or GUI: get the graphical user interface.
            ...
            switch (choice) {
                ...
                case "105", "VCS" -> foodCenter.viewCustomersSortedAlphabetically();
                ...
                case "112","GUI" -> {
                    System.out.println("Food center Application is starting");
                    FoodCenterApplication.launchApplication();
                }
                case "999", "EXT" -> {
                    scanner.close();
